        ...
        <div className="bg-gradient-to-r from-[#0f1729] via-[#0b3db5] to-[#0f1729] px-8 py-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                href="/docs/guide-administrateur-ibig-v1.docx"
                download="Guide_Administrateur_IBIG_PARTNERS_V1.docx"
                className="flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 hover:bg-white/20 px-5 py-3.5 text-sm font-semibold text-white transition-all"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Guide Admin DOCX V1.0
              </a>
              <button
              onClick={generatePDF}
              disabled={loading}
              className="flex items-center gap-2 rounded-xl bg-yellow-400 hover:bg-yellow-300 disabled:opacity-60 px-6 py-3.5 text-sm font-bold text-slate-900 transition-all shadow-xl"
            >
              {loading ? (
                <>
