...
const NAV: NavItem[] = [
  ...
  { href: "/admin/kyb",                         label: "KYB Entreprise",               icon: "🏢", group: "Réseau" },
  { href: "/admin/appels",                      label: "Appels à partenaires",         icon: "📣", group: "Réseau" },
  ...
  { href: "/admin/import-missions", label: "Import 500 missions", icon: "📥", group: "Administration" },
