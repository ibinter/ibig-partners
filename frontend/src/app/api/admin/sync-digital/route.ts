...
const DIGITAL_PRODUCTS = [
  ...
  },
  {
    ...
    rate: 8,
    siteUrl: BASE,
    description: "Développement d'une plateforme web ou application mobile sur mesure : portail client, espace membre, marketplace, application métier ou SaaS. Analyse des besoins, conception UX/UI, développement, tests et déploiement inclus. Pour entreprises ayant des besoins spécifiques non couverts par les solutions standard. Sur devis à partir de 1 500 000 FCFA.",
  },
  {
  ...
  // ── Application Mobile ────────────────────────────────────────────────
  {
    ...
    rate: 8,
    siteUrl: BASE,
    description: "Développement d'une application Android native : conception UX/UI, développement, tests sur appareils, publication sur Google Play Store et support post-lancement. Commande en ligne, réservation, catalogue, espace client ou application métier. Pour entreprises et startups souhaitant toucher les utilisateurs Android en Afrique. Sur devis à partir de 900 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: BASE,
    description: "Production de contenus vidéo professionnels : vidéo de présentation d'entreprise, spot publicitaire, tutoriel produit, témoignage client ou motion design animé. Tournage, montage et sous-titrage inclus. Pour entreprises souhaitant un contenu vidéo percutant pour leurs réseaux et site web. À partir de 250 000 FCFA.",
  },
  {
  ...
  // ── Cybersécurité ─────────────────────────────────────────────────────
  {
    ...
    rate: 8,
    siteUrl: BASE,
    description: "Évaluation complète de la sécurité de votre système d'information : scan des vulnérabilités, test de pénétration (pentest) du site web et des applications, analyse des accès et des configurations, rapport de risques et plan de remédiation. Pour entreprises souhaitant sécuriser leur SI avant un incident. À partir de 600 000 FCFA.",
  },
  {
