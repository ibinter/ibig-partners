...
const EDUFORM_PRODUCTS = [
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Audit & Contrôle Interne PME (35h). Mettre en place et piloter le contrôle interne dans une PME : évaluation des risques, cartographie des processus et des contrôles, tests de conformité, audit interne (planification, réalisation, rapport), gestion des recommandations et suivi. Pour responsables administratifs, contrôleurs de gestion et dirigeants. Code : F055-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Risques Financiers & Climatiques dans les Banques (40h). Identifier et gérer les risques financiers contemporains : risque de crédit, risque de marché, risque de liquidité, risques ESG et changement climatique dans les portefeuilles bancaires, stress tests, Pilier II de Bâle III et reporting TCFD. Pour risk managers, directeurs financiers et régulateurs. Code : F393-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Digitalisation des Processus Comptables (30h). Transformer la comptabilité grâce au digital : outils de comptabilité cloud (Sage Online, Wave, QuickBooks), GED comptable, dématérialisation des factures, automatisation des saisies (OCR, IA), rapprochement bancaire automatisé, intégration ERP-comptabilité et tableau de bord en temps réel. Pour experts-comptables, DAF et responsables comptables. Code : F394-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Audit & Commissariat aux Comptes (40h). Maîtriser les normes d'audit légal : planification de la mission, évaluation du contrôle interne, tests substantifs, audit des cycles (ventes, achats, paie, immobilisations), certification des comptes, rédaction des rapports d'audit et du rapport général du commissaire aux comptes. Pour auditeurs, experts-comptables et stagiaires CAC. Code : F395-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Management RH Agile & Stratégique (35h). Positionner la fonction RH comme partenaire stratégique : SIRH et data RH, RH business partner, agilité organisationnelle, culture d'entreprise et engagement collaborateur, gestion prévisionnelle des emplois (GPEC 2.0), marque employeur et recrutement employer branding, reporting RH et tableaux de bord stratégiques. Pour DRH et responsables RH confirmés. Code : F064-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Politique RH pour PME (30h). Structurer et formaliser la politique RH d'une PME : rédaction du règlement intérieur et de la charte des valeurs, conception des fiches de poste et grilles salariales, procédures de recrutement et d'intégration, système d'évaluation des performances, politique de formation et bien-être au travail. Pour dirigeants et responsables RH de PME. Code : F066-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion des Conflits & Climat Social (25h). Prévenir et résoudre les conflits en entreprise : diagnostic du climat social, typologies des conflits (individuels, collectifs), techniques de médiation et négociation sociale, gestion des situations de crise (grève, délégués du personnel), communication constructive et culture de la paix sociale. Pour DRH, managers et responsables d'équipe. Code : F067-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — ISO 30414 Indicateurs RH (35h). Mettre en place le reporting sur le capital humain selon la norme ISO 30414 : 23 indicateurs clés (effectifs, diversité, compétences, leadership, bien-être, productivité), collecte de données RH, construction du tableau de bord RH, reporting aux dirigeants et communication externe. Pour DRH, responsables reporting RH et directeurs généraux. Code : F068-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Tableaux de Bord RH & KPI (25h). Piloter la performance RH avec les données : sélection et calcul des KPI RH (turn-over, absentéisme, coût de recrutement, formation par ETP, satisfaction), construction du tableau de bord sous Excel et Power BI, présentation à la direction, benchmark et alertes. Pour responsables RH, contrôleurs de gestion et DRH. Code : F070-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Conformité RH & Inspection du Travail (25h). Assurer la conformité légale de la gestion des ressources humaines : affichages obligatoires, registres du personnel et de sécurité, conformité des contrats de travail, déclarations CNPS et organismes sociaux, préparation aux contrôles de l'inspection du travail et gestion des suites. Pour DRH, directeurs administratifs et chefs d'entreprise. Code : F072-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  // ── QHSE — compléments ───────────────────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion des Risques QHSE (30h). Identifier, évaluer et maîtriser les risques en entreprise : méthodes d'analyse des risques (AMDEC, What-If, arbre des causes), Document Unique d'Évaluation des Risques Professionnels (DUERP), plan de prévention, indicateurs QHSE, communication des risques et culture sécurité. Pour responsables QHSE, HSE et managers. Code : F029-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Management Environnemental & DD (30h). Intégrer les enjeux environnementaux dans la stratégie d'entreprise : analyse environnementale, réglementation environnementale, ISO 14001 (Système de Management Environnemental), bilan carbone, économie circulaire, gestion des déchets et des émissions, rapport RSE/ESG. Pour responsables environnement, QHSE et développement durable. Code : F032-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion des Déchets & Environnement (25h). Gérer les déchets industriels et urbains dans le respect de la réglementation : classification des déchets (dangereux, non dangereux, inertes), filières de valorisation, traçabilité des déchets, agrément et registres obligatoires, sous-traitance de traitement, gestion des déchets spéciaux (électroniques, médicaux). Pour responsables environnement, QHSE et collectivités. Code : F077-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — RSE : Responsabilité Sociétale des Entreprises (30h). Concevoir et déployer une stratégie RSE : référentiels RSE (ISO 26000, GRI, OCDE), diagnostic ESG (Environnement, Social, Gouvernance), cartographie des parties prenantes, politique RSE et code de conduite, reporting RSE/développement durable et communication externe. Pour dirigeants, responsables RSE et DRH. Code : F078-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Enquêtes & Accidents de Travail (25h). Mener une enquête d'accident de travail et tirer des leçons : procédure légale de déclaration, méthodes d'analyse causale (arbre des causes, ICTSI, 5 pourquoi), enquête de terrain, rédaction du rapport d'accident, plan d'actions préventives et suivi. Pour responsables HSE, médecins du travail, RH et managers. Code : F084-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Automatisation RH & GED (30h). Digitaliser les processus RH et documentaires : déploiement d'une solution GED (SharePoint, DocuWare, Alfresco), automatisation des workflows RH (congés, recrutement, onboarding), signature électronique, archivage légal numérique et conformité. Pour DRH, responsables IT et gestionnaires documentaires. Code : F093-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Excel Avancé : Power Query & Analyse (25h). Exploiter Excel pour l'analyse de données avancée : Power Query (connexion et transformation des données), Power Pivot (modèle de données, DAX), tableaux croisés dynamiques avancés, graphiques dynamiques, formules matricielles (INDEX/EQUIV, XLOOKUP), automatisation par macros VBA de base. Pour analystes, comptables et responsables reporting. Code : F098-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — ISO 27001 Lead Auditor (40h). Implémenter et auditer un Système de Management de la Sécurité de l'Information (SMSI) selon ISO 27001 : exigences de la norme, analyse des risques (ISO 27005), sélection des contrôles (Annexe A), plan de traitement des risques, audit interne SMSI et préparation à la certification. Pour RSSI, auditeurs et DSI. Code : F390-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Microsoft 365 : Outils Collaboratifs (20h). Maîtriser la suite Microsoft 365 en entreprise : Teams (messagerie, réunions, canaux), SharePoint (gestion documentaire), OneDrive (stockage et partage), Outlook avancé, Forms et Planner. Collaboration en temps réel, gestion des droits d'accès et sécurité des données en entreprise. Code : F425-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Formation Pratique — Communication Digitale : Slack, ChatGPT & Outils IA (14h). Utiliser les outils d'IA et de communication modernes en entreprise : Slack (canaux, intégrations, automatisations), ChatGPT et IA générative pour la productivité (rédaction, résumés, code, images), Workplace by Meta, Microsoft Copilot et bonnes pratiques de collaboration asynchrone. Code : F428-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 50 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Introduction à l'IA : Concepts & Outils (25h). Comprendre et utiliser l'intelligence artificielle sans coder : fondamentaux de l'IA (machine learning, deep learning, IA générative), outils IA accessibles (ChatGPT, Gemini, Claude, Midjourney, Copilot), cas d'usage métiers (marketing, finance, RH, juridique, logistique), enjeux éthiques et réglementaires de l'IA. Code : F430-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  // ── Management — compléments ─────────────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Manager Coach (30h). Développer une posture de manager-coach pour accompagner et développer son équipe : fondamentaux du coaching professionnel (écoute active, questionnement puissant, feedback), entretiens individuels de développement, identification des leviers de motivation, accompagnement des collaborateurs en difficulté et gestion des hauts potentiels. Pour managers, chefs d'équipe et cadres. Code : F102-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Pilotage de la Performance (30h). Concevoir et utiliser les outils de pilotage : tableaux de bord équilibrés (Balanced Scorecard), sélection et calcul des KPI par fonction, analyse des écarts et plans d'actions, revues de performance, reporting à la direction et culture de la mesure. Pour directeurs, contrôleurs de gestion et managers. Code : F108-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Intelligence Émotionnelle au Travail (25h). Développer l'intelligence émotionnelle (IE) pour mieux travailler avec les autres : les 5 composantes de l'IE (Goleman), conscience de soi, maîtrise de soi, empathie, motivation et compétences sociales, gestion de l'ego en réunion et en négociation, leadership émotionnel. Pour managers, commerciaux et professionnels en contact. Code : F111-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    slug: "eduform-leadership-feminin",
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Leadership Féminin (25h). Développer son leadership en tant que femme en milieu professionnel : identifier et surmonter les freins inconscients (syndrome de l'imposteur, plafond de verre), affirmer son style de leadership, négociation salariale et de carrière, réseautage stratégique, communication assertive et entrepreneuriat féminin. Pour femmes managers, cadres et entrepreneures. Code : F116-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Leadership & Transformation Digitale (40h). Piloter la transformation numérique de son organisation : stratégie de transformation digitale, conduite du changement numérique, gouvernance des données, IA et Big Data appliqués à la prise de décision managériale, culture digitale d'entreprise, gestion des risques cyber et leadership à l'ère numérique. Pour dirigeants, DSI et cadres supérieurs. Code : F405-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Contrats Commerciaux & Risques (30h). Négocier, rédiger et gérer les contrats commerciaux : éléments essentiels d'un contrat valide, clauses clés (responsabilité, pénalités, résiliation, force majeure, confidentialité), contrats internationaux (Incoterms), gestion des litiges et modes alternatifs de règlement (arbitrage, médiation CCJA). Pour acheteurs, commerciaux et juristes. Code : F121-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion Juridique PME & Startups (30h). Sécuriser juridiquement une PME ou startup : choix de la forme juridique, rédaction des statuts, pactes d'associés, protection de la propriété intellectuelle, contrats de travail et freelance, conformité réglementaire sectorielle, gestion des litiges avec clients et fournisseurs et recours à l'avocat. Pour fondateurs, dirigeants et responsables administratifs. Code : F123-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Droit Immobilier & Litiges Fonciers (30h). Maîtriser le droit immobilier ivoirien et résoudre les litiges fonciers : régimes fonciers en Côte d'Ivoire (coutumier, rural, urbain), titres fonciers et certificats fonciers, procédures d'immatriculation, baux (habitation, commercial), litiges locatifs, expropriation et voies de recours. Pour agents immobiliers, notaires, juristes et investisseurs. Code : F130-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Entrepreneuriat — compléments ────────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Stratégie de Croissance PME & Startups (30h). Développer et accélérer la croissance d'une entreprise : diagnostic stratégique (SWOT, PESTEL, forces de Porter), stratégies de croissance (pénétration, diversification, internationalisation), alliances et partenariats, financement de la croissance, pivots stratégiques et management en phase d'hypercroissance. Pour dirigeants de PME, fondateurs et consultants. Code : F138-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Entrepreneuriat Féminin & Leadership (25h). Créer et développer son entreprise en tant que femme : identification de son projet entrepreneurial, financement accessible aux femmes (fonds AFD, Banque Mondiale, BOAD, financement participatif), conciliation vie professionnelle/personnelle, réseautage féminin (AWA, AFWO, réseaux locaux), accès aux marchés et leadership au féminin. Code : F153-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Entrepreneuriat Social & Solidaire (25h). Créer et développer une entreprise à impact positif : définition et modèles de l'entrepreneuriat social (coopératives, mutuelles, associations, entreprises solidaires), théorie du changement, mesure de l'impact social (SROI), financements dédiés (impact investing, crowdfunding solidaire), certification B Corp et labellisation ESS. Code : F401-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  // ── Logistique & BTP — compléments ──────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Planification Logistique & Stock (30h). Optimiser la gestion des stocks et la planification logistique : prévision de la demande, méthodes de gestion des stocks (ABC, FIFO/LIFO, kanban), calcul des stocks de sécurité et du point de commande, gestion des entrepôts, inventaires physiques, TMS et WMS. Pour responsables logistique, acheteurs et gestionnaires de stock. Code : F158-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion de Projets BTP (35h). Piloter un projet de construction de A à Z : planification (planning Gantt, PERT), maîtrise des coûts (devis, métrés, budget travaux), suivi de la qualité (réception, levée de réserves), gestion des intervenants (MOE, MOA, sous-traitants), réunions de chantier, Procès-Verbal de Réception et décompte final. Pour conducteurs de travaux, chefs de projet BTP et maîtres d'œuvre. Code : F162-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Logistique Humanitaire & Urgences (30h). Gérer la logistique dans les crises humanitaires : spécificités de la chaîne d'approvisionnement en contexte d'urgence, achats d'urgence et passation de marchés, stockage et distribution des secours, gestion des dons en nature, coordination avec les clusters (OCHA, UNJLC), systèmes d'information logistique (LogiTrack, Kobo). Pour responsables logistique d'ONG et coordinateurs humanitaires. Code : F166-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Immobilier — compléments ─────────────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Promotion Immobilière (40h). Piloter un projet immobilier de bout en bout : études de faisabilité, acquisition foncière et sécurisation juridique, montage financier du projet (fonds propres, crédit promoteur, ventes sur plan VEFA), maîtrise d'ouvrage, commercialisation (contrats de réservation, actes de vente) et livraison. Pour promoteurs, investisseurs et gestionnaires de patrimoine. Code : F181-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Évaluation & Expertise Immobilière (35h). Maîtriser l'évaluation de la valeur des biens immobiliers : méthodes d'évaluation (comparaison, capitalisation des revenus, coût de remplacement), immobilier résidentiel et commercial, expertise de terrains et de baux, rédaction du rapport d'expertise, outils informatiques d'évaluation et normes IVSC. Pour agents immobiliers, notaires, banquiers et investisseurs. Code : F183-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Facility Management & Maintenance (30h). Gérer et maintenir un patrimoine immobilier en bon état : organisation du facility management, contrats de maintenance (multi-technique, ascenseurs, climatisation, sécurité), GMAO (Gestion de Maintenance Assistée par Ordinateur), budget de maintenance, énergies et développement durable dans l'immobilier. Pour responsables techniques, facilities managers et gestionnaires de patrimoine. Code : F398-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Tourisme, Événementiel & Soft Skills — compléments ──────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Accueil VIP & Excellence du Service (20h). Offrir un accueil d'exception aux clients et visiteurs de marque : protocole d'accueil et etiquette professionnelle, techniques d'accueil VIP, gestion des attentes, traitement des réclamations avec élégance, communication verbale et non-verbale de qualité, image de marque et représentation de l'entreprise. Pour hôtesses, assistantes et professionnels de l'accueil. Code : F205-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Soft Skills pour Assistantes (20h). Développer les compétences comportementales essentielles au poste d'assistante de direction : discrétion et confidentialité, gestion du stress, assertivité et communication, sens des priorités et gestion des urgences, intelligence relationnelle avec la hiérarchie et les équipes, image professionnelle et représentation. Code : F209-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Événementiel Digital & Virtuel (25h). Organiser des événements professionnels en ligne ou hybrides : conception d'un webinaire ou conférence virtuelle, choix et maîtrise des plateformes (Zoom Webinars, Teams Events, Hopin, EventBrite), communication et promotion digitale, gestion de l'expérience participant, animation interactive et suivi post-événement. Pour chargés d'événementiel, communicants et responsables formation. Code : F214-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Marketing d'Influence & Contenu (25h). Développer une stratégie de contenu et collaborer avec les influenceurs : content marketing (types de contenu, planning éditorial, SEO), identification et sélection des influenceurs (nano, micro, macro), briefing et contractualisation, campagnes d'influence, métriques de performance et ROI des collaborations. Pour responsables marketing, community managers et entrepreneurs. Code : F230-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Plan Marketing & Commercial (30h). Construire et piloter un plan marketing et commercial : diagnostic marché (SWOT, études de marché), définition des objectifs SMART, stratégie marketing mix (4P/7P), plan d'action commercial (cibles, canaux, budgets, KPI), mise en œuvre et suivi des performances. Pour responsables marketing, directeurs commerciaux et dirigeants de PME. Code : F240-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Emailing & Automatisation Ventes (20h). Créer des campagnes email efficaces et automatiser le processus de vente : liste de contacts et segmentation, conception et rédaction d'emails percutants, outils professionnels (Mailchimp, Brevo, HubSpot), séquences d'automatisation (welcome series, nurturing, relance panier), A/B testing et analyse des métriques (taux d'ouverture, CTR, conversion). Code : F251-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Analyse Performance Commerciale (25h). Mesurer et améliorer les performances commerciales : KPI commerciaux (chiffre d'affaires, taux de conversion, panier moyen, coût d'acquisition), construction du tableau de bord commercial sous Excel et Power BI, analyse des ventes par produit/région/canal, détection des tendances et prise de décision basée sur les données. Pour directeurs commerciaux, contrôleurs de gestion et managers. Code : F255-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  // ── Banque & Assurance — compléments ─────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Formation Pratique — Métiers de la Banque & Assurance (20h). Découvrir l'environnement bancaire et assurantiel : organisation et rôles dans une banque (front, middle, back office), principaux produits bancaires (dépôts, crédits, placements), types d'assurance (vie, IARD, santé, micro-assurance), régulateurs (BCEAO, CIMA), parcours de carrière et compétences requises. Pour étudiants et professionnels en reconversion. Code : F256-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Crédits & Recouvrement Bancaire (35h). Maîtriser l'analyse crédit et les techniques de recouvrement : analyse financière d'un dossier de crédit (particulier et entreprise), scoring et notation, garanties bancaires (hypothèques, cautions, nantissements), gestion du portefeuille de crédit, suivi des impayés, procédures de recouvrement amiable et contentieux. Pour chargés de clientèle, analystes crédit et responsables recouvrement. Code : F259-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assurances, Sinistres & Indemnisations (30h). Comprendre les mécanismes de l'assurance et la gestion des sinistres : produits d'assurance IARD (incendie, accidents, risques divers), vie et prévoyance, déclaration de sinistre, expertise, calcul de l'indemnité, litiges assuré/assureur, réglementation CIMA et protection du consommateur en assurance. Pour agents d'assurance, gestionnaires sinistres et DAF. Code : F261-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion d'une Agence Bancaire (35h). Piloter efficacement une agence bancaire : management de l'équipe (chargés de clientèle, caissiers), objectifs commerciaux et animation de la performance, conformité réglementaire, gestion des liquidités (DAB, coffre), satisfaction client et réclamations, contrôle interne de l'agence et reporting au siège. Pour directeurs d'agence et futurs chefs d'agence. Code : F272-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  ...
  // ── Développement Personnel — compléments ────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Confiance en Soi & Affirmation (20h). Développer une confiance solide pour avancer dans sa vie professionnelle et personnelle : identification des croyances limitantes, techniques d'ancrage positif, communication assertive (s'affirmer sans agressivité), gestion du regard des autres, prise de parole confiante et actions concrètes pour sortir de sa zone de confort. Code : F276-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Résilience & Adaptabilité (20h). Développer la capacité à rebondir face aux défis professionnels et personnels : comprendre les phases du changement (Kübler-Ross), techniques de gestion de l'incertitude, cultivation de la résilience (mindset de croissance, ressources internes), maintien de la performance dans l'adversité et anticipation des transformations. Code : F293-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Négociation Internationale & Diplomatie (35h). Maîtriser la négociation dans un contexte international et multiculturel : styles de négociation par culture (Harvard Negotiation Project, niveaux de contexte de Hall), préparation d'une négociation internationale (BATNA, ZOPA), protocole diplomatique et relations d'affaires interculturelles, gestion des situations de blocage et compromis interculturels. Pour dirigeants, diplomates et négociateurs internationaux. Code : F407-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  ...
  // ── Humanitaire & ONG — compléments ─────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestion Financière & Comptable ONG (35h). Gérer les finances d'une ONG ou association dans les règles de l'art : planification budgétaire des projets, comptabilité analytique par projet et par bailleur, trésorerie et contrôles internes, rapports financiers aux bailleurs (USAID, UE, AFD, PNUD), audit externe et conformité SYCEBNL. Pour comptables et responsables administratifs et financiers d'ONG. Code : F409-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Plaidoyer & Communication ONG (30h). Conduire des campagnes de plaidoyer efficaces pour faire valoir une cause : définition d'une stratégie de plaidoyer (objectifs, cibles, messages), cartographie des décideurs et alliés, techniques de lobbying institutionnel, communication externe et campagnes de sensibilisation, utilisation des médias et réseaux sociaux pour le plaidoyer. Pour responsables de plaidoyer, coordinateurs et directeurs d'ONG. Code : F414-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Leadership Humanitaire & Coordination de Crise (35h). Piloter une réponse humanitaire complexe : leadership en contexte de crise, coordination humanitaire (clusters, OCHA, mécanismes HCT), planification de la réponse d'urgence, gestion des équipes sous pression, communication de crise, sécurité des équipes sur le terrain et principes humanitaires (humanité, impartialité, neutralité). Code : F415-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  ...
  // ── Gestion de Projets — compléments ────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Gestion de Projets Avancée (40h). Maîtriser les standards internationaux de gestion de projets : PMBOK (Guide PMI) — 49 processus et 10 domaines de connaissance, préparation à la certification PMP, méthodologie Prince2 (7 principes, thèmes, processus), comparaison Predictive vs. Agile, outils avancés (MS Project, Primavera). Pour chefs de projet expérimentés et aspirants PMP. Code : F417-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Risques & Qualité dans les Projets (30h). Intégrer la gestion des risques et la qualité dans ses projets : identification et analyse des risques (matrice probabilité/impact), stratégies de réponse (évitement, atténuation, acceptation, transfert), registre des risques, plan qualité projet, contrôle qualité, revues de qualité et leçons apprises. Pour chefs de projet, ingénieurs et responsables qualité. Code : F419-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Microfinance & Inclusion Financière (30h). Maîtriser les métiers de la microfinance : histoire et enjeux de l'inclusion financière en Afrique, produits de microfinance (microcrédit, épargne, micro-assurance, mobile money), analyse de la clientèle à faibles revenus, montage et suivi de dossiers de microcrédit, recouvrement et gestion des impayés, réglementation des IMF (BCEAO). Code : F300-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Développement Durable & RSE (35h). Piloter la stratégie RSE et développement durable d'une organisation : diagnostic ESG, stratégie de durabilité, bilan carbone et plan de réduction des émissions, reporting extra-financier (GRI, SASB, CSRD), engagement des parties prenantes, communication RSE et labels/certifications durables. Pour responsables RSE, développement durable et dirigeants engagés. Code : F309-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Logistique & Transport Maritime (40h). Maîtriser la logistique maritime et portuaire : organisation du transport maritime international, types de navires et modes d'affrètement, Incoterms 2020, documents du commerce maritime (connaissement, certificat d'origine, liste de colisage), gestion d'un port (douanes, manutention, stockage portuaire), freight forwarders et commissionnaires. Code : F324-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Marketing Digital & E-commerce (40h). Piloter la présence digitale et les ventes en ligne d'une marque : stratégie digitale multicanal, SEO (référencement naturel), publicité digitale (Google Ads, Meta Ads), gestion d'une boutique e-commerce (WooCommerce, Shopify), logistique e-commerce et expérience client, analytics (Google Analytics 4) et tableaux de bord de performance digitale. Code : F331-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  ...
  // ── Formations Métiers Administratifs — compléments ──────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assistant Administratif & Bureautique (25h). Acquérir les bases du travail administratif : rédaction professionnelle (lettres, emails, notes, comptes-rendus), maîtrise des outils bureautiques (Word, Excel, Outlook, PowerPoint), organisation des dossiers et de l'espace de travail, gestion du courrier entrant et sortant, accueil téléphonique et physique. Pour débutants souhaitant s'insérer dans des postes administratifs. Code : F336-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestionnaire Administratif & Logistique (30h). Combiner gestion administrative et logistique opérationnelle : coordination des services généraux (parc auto, entretien, fournitures de bureau), gestion des contrats de service, suivi budgétaire des coûts administratifs, organisation des déplacements professionnels, gestion des inventaires et des livraisons, communication inter-services. Code : F338-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assistant Polyvalent PME/ONG (25h). Maîtriser les compétences multidisciplinaires d'un assistant polyvalent dans une PME ou une ONG : administration quotidienne, appui comptable (saisie, classement des pièces), ressources humaines de base (suivi congés, dossiers), communication interne, logistique de bureau et coordination entre services. Pour assistants souhaitant évoluer dans des structures à taille humaine. Code : F339-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Responsable Services Généraux (30h). Gérer l'ensemble des services généraux d'une organisation : gestion du patrimoine mobilier et immobilier (location, entretien), gestion de flotte automobile, marchés de services (nettoyage, sécurité, restauration, énergie), budget des services généraux, gestion des prestataires et contrats de maintenance, déménagements et aménagements. Code : F342-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assistant en Gestion de Projets (25h). Soutenir efficacement un chef de projet dans ses missions quotidiennes : tenue du planning et du registre des tâches, préparation des réunions et comptes-rendus, suivi du budget, collecte et organisation des livrables, communication avec les parties prenantes, reporting de l'avancement et utilisation des outils (Trello, Asana, MS Project). Code : F343-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Secrétaire Médical & Administratif (30h). Exercer les fonctions de secrétariat dans un établissement de santé : accueil des patients, gestion des rendez-vous, dossiers médicaux et confidentialité, facturation et prise en charge assurance maladie, terminologie médicale, rédaction de courriers médicaux et ordonnances, coordination avec les équipes soignantes. Code : F367-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Formations Métiers Administratifs — dernière vague ───────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Suivi & Reporting Administratif (25h). Assurer le suivi des activités et produire les rapports administratifs d'une organisation : tableaux de bord de suivi des activités, rapports périodiques (hebdo, mensuel, trimestriel), collecte et traitement des données administratives, outils de reporting (Excel, Google Sheets), présentation des résultats à la hiérarchie. Code : F344-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Gestionnaire de Bureau & Secrétariat Général (30h). Coordonner le fonctionnement quotidien d'un bureau ou d'un secrétariat général : planification et coordination des tâches administratives, gestion de l'espace de travail et des fournitures, supervision du courrier entrant/sortant, archivage physique et numérique, coordination des services de support et représentation de l'organisation. Code : F345-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Administratif & Opérationnel (35h). Piloter la fonction administrative d'une organisation : supervision des équipes administratives, gestion des contrats de prestataires, coordination logistique, suivi budgétaire des coûts administratifs, conformité réglementaire et reporting à la direction générale. Pour responsables administratifs et secrétaires généraux. Code : F346-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assistant RH & Administration Personnel (30h). Assister la DRH dans l'ensemble des tâches administratives RH : gestion des dossiers du personnel, préparation des contrats et avenants, suivi des absences et des congés, préparation des éléments variables de paie, déclarations sociales de base, onboarding administratif des nouveaux entrants. Code : F347-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Accueil & Relations Publiques (20h). Représenter l'image de l'organisation à travers un accueil professionnel : techniques d'accueil physique et téléphonique, gestion des visiteurs (badges, orientation), communication institutionnelle externe, protocole et étiquette professionnelle, gestion des situations difficiles et représentation lors d'événements. Code : F348-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Secrétaire Juridique (30h). Soutenir une équipe juridique dans ses missions administratives : rédaction de courriers et d'actes juridiques simples, gestion des délais de procédure, tenue des registres légaux (assemblées, registre du commerce), classement des dossiers juridiques, interface avec le greffe des tribunaux, notaires et huissiers, terminologie juridique. Code : F359-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Dossiers & Archives Numériques (25h). Gérer les dossiers et archives à l'ère du numérique : numérisation et indexation des documents, plan de classement numérique, métadonnées et recherche documentaire, solutions de GED (SharePoint, Google Drive, Alfresco), durées légales de conservation par type de document, destruction sécurisée. Code : F360-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Suivi Budgétaire Administratif (30h). Assurer le suivi des dépenses et du budget administratif : construction d'un budget de fonctionnement, suivi des engagements et des dépenses, traitement des bons de commande et factures, tableaux de bord des dépenses, signalement des écarts et préparation des révisions budgétaires. Pour assistants administratifs et financiers. Code : F362-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Assistant Gestion des Appels d'Offres (30h). Préparer et suivre les réponses aux appels d'offres : veille des appels d'offres (journaux officiels, plateformes), constitution du dossier administratif (attestations, bilans, références), coordination de la réponse technique et financière, respect des délais et dépôt des offres, suivi post-soumission et classement. Code : F364-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Administration Générale (40h). Superviser l'ensemble des fonctions administratives d'une organisation : coordination des départements (RH, finances, logistique, IT), gestion des obligations légales et réglementaires, rédaction des procédures internes, gestion des contrats stratégiques, représentation institutionnelle et reporting à la direction générale. Pour secrétaires généraux et directeurs administratifs. Code : F358-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
  ...
  // ── Formations Métiers Techniques — dernière vague ────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Achats Internationaux & Supply Chain (40h). Gérer les achats et la chaîne d'approvisionnement à l'international : sourcing international, Incoterms 2020, négociation avec les fournisseurs étrangers, gestion des contrats internationaux, financement des importations (crédits documentaires, remises documentaires), douanes et transport multimodal, gestion des risques supply chain. Code : F329-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Export & Développement International (40h). Développer les activités d'exportation d'une entreprise : étude de marchés cibles, réglementation douanière et des changes, stratégies d'entrée sur les marchés étrangers (agent, distributeur, filiale, joint-venture), financement des exportations (COFACE, assurance-crédit), négociation interculturelle et logistique export. Code : F332-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Conseiller Financier & Gestion de Patrimoine (40h). Accompagner les clients dans la gestion et l'optimisation de leur patrimoine : bilan patrimonial, stratégies de placement (SICAV, obligations, actions, immobilier, épargne retraite), fiscalité du patrimoine, transmission et succession, ingénierie patrimoniale et solutions d'assurance vie. Pour conseillers en gestion de patrimoine (CGP) et banquiers privés. Code : F334-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Transformation Digitale (40h). Piloter la transformation numérique d'une organisation : diagnostic de maturité digitale, stratégie de transformation (roadmap digitale), conduite du changement technologique, gouvernance des données, mise en œuvre des solutions digitales clés (ERP, CRM, IA, cloud), communication et accompagnement des équipes dans le changement. Pour directeurs de la transformation et DSI. Code : F322-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Chargé de Clientèle Bancaire (35h). Maîtriser les missions d'un chargé de clientèle en banque de détail : accueil et orientation des clients, vente de produits bancaires (comptes, cartes, crédits à la consommation, assurances), analyse des besoins et conseils financiers, gestion du portefeuille client, traitement des réclamations et fidélisation, conformité KYC. Code : F317-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable QSE (40h). Déployer et piloter un Système de Management Intégré QSE : intégration des référentiels ISO 9001, ISO 45001 et ISO 14001 dans un SMI cohérent, planification et réalisation des audits QSE, gestion des non-conformités et actions correctives, animation de la culture QSE dans l'entreprise et préparation aux certifications. Code : F319-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Spécialiste Passation de Marchés (40h). Maîtriser les procédures de passation de marchés publics et privés : cadre réglementaire des marchés publics en Côte d'Ivoire (décret marché public), types de procédures (appel d'offres ouvert/restreint, gré à gré, consultation), rédaction des DAO, évaluation des offres, attribution et notification, exécution des contrats et réception des travaux/fournitures/services. Code : F320-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Responsable Centre d'Appels (35h). Gérer et optimiser les performances d'un centre d'appels : organisation et management de l'équipe (superviseurs, agents), KPI centre d'appels (DMT, taux de décroché, taux de résolution au premier appel, NPS), formation et coaching des agents, gestion des pics d'activité, outils CRM et téléphonie (VOIP, ACD), amélioration de l'expérience client omnicanale. Code : F327-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Gestion de Projets Agricoles & Agro-business (35h). Concevoir et piloter des projets agricoles rentables : analyse de filières agricoles (cacao, café, anacarde, maïs...), montage de projets agricoles (étude de faisabilité, plan d'affaires, financement), gestion des intrants et des cycles de production, commercialisation et transformation agroalimentaire, FIDA/BAD/BOAD financement agricole. Code : F315-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 120 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Ressources Humaines 4.0 (40h). Maîtriser les RH à l'ère du digital et de l'IA : SIRH de nouvelle génération (SAP SuccessFactors, Workday, BambooHR), recrutement digital et IA (ATS, matching algorithmique), gestion de la marque employeur digitale, analytics RH et people analytics, télétravail et gestion des équipes hybrides, compétences futures et IA dans les RH. Code : F333-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Programme Certifiant — Gestion de Portefeuille Immobilier (40h). Gérer et optimiser un portefeuille de biens immobiliers : stratégie d'investissement immobilier, analyse de rentabilité (TRI, cash-flow, taux de capitalisation), gestion des locataires et des baux, arbitrage (achat/vente), financement et refinancement du portefeuille, fiscalité immobilière et reporting aux investisseurs. Code : F330-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 150 000 FCFA.",
  },
  {
  ...
  // ── Droit & Conformité — dernière vague ──────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Veille Légale & Réglementaire (25h). Mettre en place et animer une veille juridique et réglementaire efficace : sources du droit (JOCE, JORCI, BCEAO, sites officiels), outils de veille juridique (Legifrance, Dalloz, bases locales), analyse et synthèse des textes réglementaires, diffusion interne des alertes, mise à jour des procédures et conformité continue. Pour juristes, compliance officers et responsables administratifs. Code : F119-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Conformité Fiscale & Contrôle Administratif (30h). Gérer les obligations fiscales et se préparer aux contrôles : déclarations fiscales obligatoires (TVA mensuelle, acomptes IS/BIC, patente, IRVM), respect des délais légaux, documentation justificative, gestion d'un contrôle fiscal (droits du contribuable, réponse aux notifications, recours gracieux et contentieux). Pour comptables, DAF et dirigeants. Code : F122-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Droit Fiscal & Contentieux (35h). Comprendre le droit fiscal et gérer les litiges avec l'administration fiscale : assiette et liquidation des principaux impôts (IS, TVA, IRVM, patente), vérification de comptabilité, notification de redressement et droits du contribuable, recours amiable devant le fisc, contentieux fiscal devant les tribunaux administratifs. Pour avocats fiscalistes, experts-comptables et DAF. Code : F134-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Créativité, Initiative & Innovation (20h). Développer sa créativité et sa capacité à innover au travail : techniques de créativité (brainstorming, SCAMPER, mind mapping, design thinking), surmonter les blocages créatifs, passage de l'idée à l'action, culture de la prise d'initiative en entreprise, pilotage de petits projets d'amélioration continue et présentation des idées. Code : F207-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 60 000 FCFA.",
  },
  {
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Leadership Féminin & Soft Skills (25h). Combinaison de compétences comportementales et de leadership spécifiquement orientée femmes en activité : assertivité et confiance en soi, communication persuasive, gestion des réseaux professionnels, équilibre vie pro/perso, gestion du stress spécifique aux femmes en poste de responsabilité, mentoring et soutien entre femmes professionnelles. Code : F215-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 75 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Vidéo Corporate & Formats Réseaux (25h). Produire des vidéos professionnelles pour les réseaux sociaux et la communication d'entreprise : écriture du script et storyboard, tournage avec smartphone ou caméra (cadrage, lumière, son), montage vidéo (CapCut, DaVinci Resolve, Premiere Rush), formats adaptés aux plateformes (Reels, Shorts, stories, LinkedIn), sous-titrage et publication. Code : F231-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Communication ONG & Humanitaire (25h). Communiquer efficacement dans le secteur humanitaire et associatif : communication institutionnelle ONG (rapport annuel, newsletter, site web), communication bailleurs (rapports narratifs, livrables), communication avec les bénéficiaires et communautés, médias sociaux pour les ONG, storytelling humanitaire et éthique de l'image dans le secteur. Code : F235-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 75 000 FCFA.",
  },
  ...
  // ── Marketing — dernière vague ───────────────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Management d'Équipe Commerciale (35h). Animer et piloter une force de vente performante : recrutement et intégration des commerciaux, fixation d'objectifs et systèmes de rémunération variable, animation commerciale (réunions hebdo, challenges, incentives), coaching terrain, gestion des underperformers, CRM et outils de pilotage de l'équipe commerciale. Pour directeurs commerciaux et chefs des ventes. Code : F243-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Branding & Positionnement (30h). Définir et renforcer le positionnement stratégique d'une marque : analyse concurrentielle du positionnement, formulation de la proposition de valeur unique (USP), architecture de marque, brand guidelines (logo, couleurs, typographie, ton éditorial), déploiement de la marque sur tous les points de contact et suivi de la notoriété (brand tracking). Pour responsables marketing et entrepreneurs. Code : F245-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Distribution, Merchandising & Force de Vente (30h). Optimiser la présence des produits en point de vente : stratégies de distribution (intensive, sélective, exclusive), merchandising (facing, linéarisation, mise en avant), trade marketing et relations distributeurs, animation de la force de vente terrain (brief, objectifs, incentives, reporting), mesure de la disponibilité en rayon (DN/DV). Pour chefs de zone, trade marketeurs et chefs des ventes. Code : F252-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Développement Personnel — dernière vague ─────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Leadership Transformationnel (30h). Développer un style de leadership qui inspire et transforme les organisations : les 4 dimensions du leadership transformationnel (influence idéalisée, motivation inspiratrice, stimulation intellectuelle, considération individuelle), leadership en période de changement, vision et communication inspirante, construction d'équipes haute performance et culture d'innovation. Code : F292-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Mindset Entrepreneurial & Mentalité Gagnante (20h). Cultiver les attitudes mentales des entrepreneurs et leaders qui réussissent : growth mindset vs fixed mindset (Dweck), gestion de la peur de l'échec, persévérance et résilience, pensée long terme vs gratification immédiate, cercle vertueux confiance-action-résultat, habitudes des personnes à haute performance (Hal Elrod, James Clear). Code : F294-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 60 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Résolution de Problèmes Design Thinking (30h). Résoudre des problèmes complexes par une approche centrée sur l'humain : méthodologie Design Thinking (Empathize, Define, Ideate, Prototype, Test), facilitation d'ateliers créatifs, sprints d'innovation (Google Design Sprint), méthodes agiles (Scrum, Kanban) appliquées à la résolution de problèmes, mesure de l'impact des solutions. Code : F406-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Équilibre Personnel-Professionnel (20h). Construire une vie épanouie en alliant performance professionnelle et bien-être personnel : audit de vie (roue de la vie), définition de ses valeurs et priorités, gestion des frontières entre vie pro et vie privée, prévention du burnout, rituels de récupération, organisation d'une semaine idéale et stratégies pour tenir dans la durée. Code : F295-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 60 000 FCFA.",
  },
  ...
  // ── Gestion de Projets — dernière vague ──────────────────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Planification, Suivi & Évaluation (35h). Concevoir et piloter un système de planification, suivi et évaluation (S&E/ME) de projets et programmes : plan de S&E, indicateurs SMART de suivi, collecte des données (KoBoToolbox, ODK), analyse des données et rapport de suivi, évaluations à mi-parcours et finales, théorie du changement et apprentissage organisationnel. Code : F418-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Outils Numériques Gestion de Projets (30h). Maîtriser les principaux logiciels de gestion de projets : Microsoft Project (planification, ressources, suivi), Jira (gestion agile, backlog, sprints, tableaux Kanban), Trello et Asana (projets opérationnels), Notion (gestion de projets documentaires), Power BI pour le reporting de projets et intégrations inter-outils. Pour chefs de projet et membres d'équipes projets. Code : F421-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Leadership & Management d'Équipes Projet (30h). Animer et fédérer une équipe projet pluridisciplinaire : constitution et développement de l'équipe projet (phases Tuckman), leadership situationnel du chef de projet, motivation et engagement des membres, gestion des conflits et des tensions intra-équipe, communication projet et réunions efficaces, gestion des équipes projet dispersées géographiquement. Code : F422-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  ...
  // ── Immobilier — formations complémentaires finales ──────────────────────
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Immobilier Social & Logement Abordable (30h). Comprendre et développer des projets de logement social et abordable : politiques nationales du logement en Afrique (CDMH, SICOGI, SCP), montage de projets de logement abordable, financements spécifiques (BHS, Habitat pour l'Humanité, AFD), partenariats public-privé immobilier, cadastre social et gestion des attributions de logements. Code : F193-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 90 000 FCFA.",
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Immobilier Durable & Éco-construction (35h). Intégrer le développement durable dans les projets immobiliers : matériaux biosourcés et locaux, conception bioclimatique, normes HQE et certifications vertes (LEED, BREEAM, HQE Afrique), efficacité énergétique des bâtiments, gestion de l'eau et des déchets de chantier, immobilier durable en contexte africain. Pour architectes, promoteurs et responsables techniques. Code : F397-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel. À partir de 105 000 FCFA.",
  },
  ...
  },
  {
    ...
    rate: 10,
    siteUrl: "https://ibig-eduform.com",
    description: "Certificat Pratique — Personal Branding & Marque Personnelle (25h). Construire et promouvoir sa marque personnelle professionnelle : définition de son identité professionnelle unique, optimisation du profil LinkedIn et des réseaux sociaux professionnels, création de contenu pour se positionner en expert, réseautage stratégique (online et offline), gestion de sa e-réputation et monétisation de son expertise. Code : F152-IBIG-EDUFORM. Disponible en e-learning, en ligne (live) et en présentiel (individuel possible). À partir de 75 000 FCFA.",
  },
