...
const EMPLOI_PRODUCTS = [
  ...
  {
    slug: "emploi-mission-recrutement-cdi",
    name: "Mission de Recrutement CDI",
    pricingType: "SERVICE",
    price: 300000,
    rate: 10,
    siteUrl: BASE,
    description: "Mission de recrutement en CDI clé en main : analyse du besoin, rédaction et diffusion de l'offre, tri des candidatures, entretiens de présélection, évaluation des compétences et présentation d'une short-list de 3 candidats qualifiés avec comptes rendus détaillés. Garantie de remplacement en cas de rupture de période d'essai. Pour entreprises cherchant un profil stable sur le long terme. À partir de 300 000 FCFA.",
  },
  {
    slug: "emploi-mission-recrutement-cdd-interim",
    name: "Mission de Recrutement CDD / Intérim",
    pricingType: "SERVICE",
    price: 150000,
    rate: 10,
    siteUrl: BASE,
    description: "Recrutement rapide de profils en CDD ou mission intérimaire : identification des candidats disponibles immédiatement, entretiens express, vérification des compétences et mise à disposition dans les meilleurs délais. Pour entreprises ayant un besoin urgent ou temporaire de renforcement d'effectifs. À partir de 150 000 FCFA.",
  },
  {
    slug: "emploi-placement-profils-qualifies",
    name: "Placement de Profils Qualifiés",
    pricingType: "SERVICE",
    price: 200000,
    rate: 10,
    siteUrl: BASE,
    description: "Placement de profils qualifiés issus de notre vivier de talents : techniciens, cadres, spécialistes sectoriels et experts. Présélection rigoureuse, tests de compétences et mise en relation directe avec l'employeur. Pour entreprises souhaitant accéder rapidement à des profils testés et disponibles sans processus de recrutement long. À partir de 200 000 FCFA.",
  },
  {
    slug: "emploi-externalisation-rh-complete",
    name: "Externalisation RH Complète",
    pricingType: "MONTHLY_SUB",
    price: 200000,
    rate: 10,
    siteUrl: BASE,
    description: "Externalisation complète de la fonction RH : gestion de la paie, administration du personnel, recrutement, formation, gestion des carrières, conformité sociale et reporting RH. Un DRH externalisé dédié à votre entreprise, disponible à temps partiel. Pour PME et ETI souhaitant disposer d'une fonction RH professionnelle sans recruter un DRH à plein temps. 200 000 FCFA/mois.",
  },
  {
    slug: "emploi-gestion-personnel-externalisee",
    name: "Gestion du Personnel Externalisée",
    pricingType: "MONTHLY_SUB",
    price: 100000,
    rate: 10,
    siteUrl: BASE,
    description: "Gestion externalisée de l'administration du personnel au quotidien : suivi des contrats, gestion des absences et congés, établissement des bulletins de paie, déclarations sociales CNPS/DIPE et gestion disciplinaire. Pour TPE et PME souhaitant déléguer la gestion administrative de leurs salariés à des experts. 100 000 FCFA/mois.",
  },
  {
    slug: "emploi-gestion-talent-pool",
    name: "Gestion de Talent Pool",
    pricingType: "MONTHLY_SUB",
    price: 150000,
    rate: 10,
    siteUrl: BASE,
    description: "Constitution et gestion d'un vivier de talents (talent pool) personnalisé pour votre entreprise : sourcing continu de candidats dans vos métiers clés, entretiens de présélection, base de données qualifiée et activation immédiate en cas de besoin. Pour entreprises à fort volume de recrutement souhaitant réduire leurs délais d'embauche. 150 000 FCFA/mois.",
  },
  {
    slug: "emploi-tests-competences-evaluation",
    name: "Tests de Compétences & Évaluation",
    pricingType: "SERVICE",
    price: 80000,
    rate: 10,
    siteUrl: BASE,
    description: "Évaluation objective des compétences techniques et comportementales des candidats ou des salariés : tests psychotechniques, tests de personnalité, mises en situation professionnelles, entretiens structurés et assessment center. Rapport d'évaluation individuel fourni. Pour recruteurs et DRH souhaitant objectiver leurs décisions de recrutement ou de promotion. 80 000 FCFA par évaluation.",
  },
  {
    slug: "emploi-formation-recruteurs-drh",
    name: "Formation Recruteurs & DRH",
    pricingType: "COURSE",
    price: 120000,
    rate: 10,
    siteUrl: BASE,
    description: "Formation pratique pour recruteurs et responsables RH : techniques d'entretien structuré, rédaction d'offres d'emploi attractives, utilisation des jobboards et réseaux sociaux pour sourcer des candidats, évaluation des compétences, droit du recrutement et lutte contre les biais. Pour DRH, chargés de recrutement et managers impliqués dans les embauches. 120 000 FCFA/personne.",
  },
  {
    slug: "emploi-portage-salarial",
    name: "Portage Salarial",
    pricingType: "SERVICE",
    price: 0,
    rate: 10,
    siteUrl: BASE,
    description: "Solution de portage salarial pour consultants, freelances et experts indépendants : IBIG EMPLOI & TALENTS porte le consultant en tant que salarié, gère la facturation, les charges sociales et la paie, tout en laissant le consultant libre de ses missions. Pour consultants souhaitant sécuriser leurs revenus avec un statut salarié sans créer d'entreprise. Tarif sur devis selon le chiffre d'affaires.",
  },
  {
    slug: "emploi-bilan-accompagnement-reconversion",
    name: "Bilan & Accompagnement Reconversion",
    pricingType: "SERVICE",
    price: 150000,
    rate: 10,
    siteUrl: BASE,
    description: "Programme complet de bilan de compétences et d'accompagnement à la reconversion professionnelle : analyse des acquis et aspirations, identification du nouveau projet professionnel, plan de formation pour combler les écarts de compétences, accompagnement dans les démarches et suivi jusqu'au premier emploi dans le nouveau domaine. Pour salariés et demandeurs d'emploi souhaitant changer de métier. 150 000 FCFA.",
  },
