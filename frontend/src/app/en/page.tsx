...
export const metadata: Metadata = {
  ...
  description:
    "Join the IBIG SARL affiliate program: one account to promote 14 business software, training, real estate, employment & HR and 55 services across 10 branches — Africa and the diaspora.",
  alternates: {
  ...
  openGraph: {
    title: "IBIG PARTNERS — Pan-African Affiliate Program",
    description:
      "One account for the entire IBIG ecosystem: 14 business software, training, real estate, employment & HR and 55 services across 10 branches — with transparent 3-level commissions.",
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:py-20 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-brand-100 sm:text-xl">
              ...
              software, professional training, real estate, employment &amp; HR
              and 55+ services across 10 branches — all from a single partner account, and earn
