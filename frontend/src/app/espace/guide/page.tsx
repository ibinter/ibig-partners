    ...
    return s;
      ...
      const prods = [
        {
          ...
          items: [
            t("Scolaby (gestion scolaire, a partir de, selon cycle/taille) - 10 000 FCFA/mois | N1=2 000, N2=1 000, N3=500 FCFA"),
            t("Scolaby Annuel (a partir de) - 100 000 FCFA/an | N1=20 000, N2=8 000, N3=3 000 FCFA"),
            t("IBIG Fleet 360 (gestion de flotte, a partir de) - 19 900 FCFA/mois | N1=3 980, N2=1 990, N3=995 FCFA"),
            t("Lokativo (gestion immobilière/locative, a partir de) - 9 900 FCFA/mois | N1=1 980, N2=990, N3=495 FCFA"),
            t("GESCOMXEL (gestion commerciale, a partir de) - 5 000 FCFA/mois | N1=1 000, N2=500, N3=250 FCFA"),
            t("Zelivry (gestion de livraison, a partir de) - 4 900 FCFA/mois | N1=980, N2=490, N3=245 FCFA"),
            t("STOCKFLOW ERP (gestion de stock, a partir de) - 5 000 FCFA/mois | N1=1 000, N2=500, N3=250 FCFA"),
            t("CONSTRUIRO ERP (gestion BTP/chantiers, a partir de) - 15 000 FCFA/mois | N1=3 000, N2=1 500, N3=750 FCFA"),
            t("SANTAREX ERP (gestion santé/cliniques, a partir de) - 12 000 FCFA/mois | N1=2 400, N2=1 200, N3=600 FCFA"),
            t("AGRIFRIK (gestion agricole, a partir de) - 6 500 FCFA/mois | N1=1 300, N2=650, N3=325 FCFA"),
            t("GESTMONEY (gestion Mobile Money, a partir de) - 9 900 FCFA/mois | N1=1 980, N2=990, N3=495 FCFA"),
            t("ANOUANZÊ ERP (gestion ONG/associations, a partir de) - 12 900 FCFA/mois | N1=2 580, N2=1 290, N3=645 FCFA"),
            t("IBIG FactPro (facturation, a partir de) - 4 900 FCFA/mois | N1=980, N2=490, N3=245 FCFA"),
            t("SECRETIS ERP (gestion secrétariat, a partir de) - 4 900 FCFA/mois | N1=980, N2=490, N3=245 FCFA"),
            t("IBIG DocPro (gestion de documents, a l'usage) - des 100 FCFA/doc | commission 20% N1 sur chaque document"),
          ],
        },
        {
      ...
      autoTable(doc,{
        ...
        body: [
          ...
          [t("Ambassadeur Silver"),t("Atteindre le statut SILVER"),t("+2% commission permanente")],
          [t("Ambassadeur Gold"),t("Atteindre le statut GOLD"),t("+5% + Chat IBIG")],
          [t("Master Partner"),t("Atteindre le statut MASTER"),t("+8% + Formation avancee")],
          [t("Elite Representant"),t("Atteindre le statut ELITE - le sommet"),t("+12% + Avantages exclusifs")],
        ],
        headStyles: { fillColor: GOLD,textColor: DARK,fontStyle: "bold",fontSize: 9 },
        bodyStyles: { fontSize: 8.5 },
        alternateRowStyles: { fillColor: LIGHT },
