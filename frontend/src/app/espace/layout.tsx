...
export default async function EspaceLayout({
  ...
  const NAV: NavItem[] = [
    ...
    { href: "/espace/produits",     label: "Mes Produits",    icon: "🧩",  group: "Mon activité", highlight: "brand" },
    { href: "/espace/mon-marche",  label: "Mon Marché",      icon: "🗺️",  group: "Mon activité" },
    ...
    { href: "/espace/portefeuille",  label: "Mon Portefeuille",      icon: "📊",  group: "Mon activité" },
    { href: "/espace/rapport",       label: "Mon Rapport mensuel",   icon: "📋",  group: "Mon activité" },
    { href: "/espace/opportunites", label: "Mes Opportunités B2B", icon: "💼", group: "Mon activité" },
    { href: "/espace/rendez-vous",  label: "Mes Rendez-vous",     icon: "📅",  group: "Mon activité" },
    ...
    { href: "/espace/missions",          label: "Missions Partners",   icon: "🎯",  group: "Mon activité", highlight: "orange" },
    { href: "/espace/recommandations",   label: "Missions recommandées",icon: "✨", group: "Mon activité" },
    ...
    { href: "/espace/evenements",   label: "Événements IBIG", icon: "📅",  group: "Formation & Communauté" },
    { href: "/espace/points",       label: "Points & Récompenses", icon: "🎁", group: "Formation & Communauté" },
    ...
    { href: "/espace/streaks",            label: "Mes Streaks",              icon: "🔥", group: "Mon activité" },
    { href: "/espace/marketplace",        label: "Marketplace",              icon: "🛒", group: "Mon activité" },
    { href: "/espace/simulateur-avance",  label: "Simulateur Revenus",       icon: "📈", group: "Mon activité" },
    { href: "/espace/ma-vitrine",         label: "Ma Vitrine",               icon: "🎨", group: "Compte" },
    ...
    { href: "/espace/reseau-visuel",       label: "Arbre de réseau",           icon: "🌐", group: "Mon activité" },
    ...
    { href: "/espace/onboarding-wizard",   label: "Guide démarrage 5 étapes", icon: "🧭", group: "Ressources" },
