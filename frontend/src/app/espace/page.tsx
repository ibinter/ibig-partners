...
export default async function DashboardPage({
  ...
  // Détection des étapes onboarding réalisées
  ...
  const onboardingDone = {
    ...
    link: linksCount > 0,
    share: false, // suivi côté client via localStorage
    prospect: prospectsCount > 0,
  };

  // Ventes confirmées de la semaine en cours (lundi-dimanche)
  ...
  return (
    <div>
      ...
      {/* Onboarding Quest — uniquement si pas toutes les étapes faites */}
