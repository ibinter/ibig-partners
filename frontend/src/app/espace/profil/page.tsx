...
export default async function ProfilPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sécurité — Changer le mot de passe (hors de la grille) */}
      <div className="rounded-2xl border border-slate-100 bg-white shadow-sm p-6">
        <h2 className="text-base font-bold text-ink mb-1">🔒 Sécurité</h2>
        <p className="text-sm text-muted mb-4">Modifier votre mot de passe de connexion.</p>
        <a
          href="/connexion/mot-de-passe-oublie"
          className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 transition"
        >
