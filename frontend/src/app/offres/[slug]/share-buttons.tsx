  ...
  return (
    <div className="rounded-2xl sm:rounded-3xl bg-white shadow-sm border border-slate-100 p-4 sm:p-6">
      ...
      <div className="flex items-center gap-2 mb-4">
        <div className="flex-1 min-w-0 rounded-xl bg-slate-50 border border-slate-200 px-3 py-2">
          <p className="text-xs text-slate-400 truncate select-all">{url}</p>
        </div>
        <button
          onClick={copyLink}
      ...
      <div className="flex flex-wrap gap-2">
        {shares.map((s) => (
          <a
            ...
            className={`inline-flex items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold transition-all ${s.color}`}
