  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 space-y-6">
        ...
        {/* Formulaire contact */}
        <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-700 mb-3">💬 Contacter {user.firstName}</h2>
          <form action={`/api/leads/contact`} method="POST" className="space-y-3">
            <input type="hidden" name="partnerCode" value={user.code} />
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <input name="phone" placeholder="Votre téléphone"
                className="rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
            ...
            <textarea name="message" rows={3} placeholder="Votre message..."
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-400 resize-none" />
            <button type="submit"
