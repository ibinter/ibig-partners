...
async function main() {
  ...
  await (prisma as any).userBadge.deleteMany().catch(() => {});
  await (prisma as any).badge.deleteMany().catch(() => {});
  await (prisma as any).trainingProgress.deleteMany().catch(() => {});
  await (prisma as any).trainingModule.deleteMany().catch(() => {});
  await (prisma as any).chatMessage.deleteMany().catch(() => {});
  await (prisma as any).chatParticipant.deleteMany().catch(() => {});
  await (prisma as any).chatConversation.deleteMany().catch(() => {});
  ...
  // --- Modules de formation (Académie IBIG) ---
